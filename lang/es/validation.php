...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para reemplazar el marcador de posición
    | de nuestro atributo con algo más legible, como "Correo electrónico" en lugar de "email".
    |
    */
