...
return [
    ...
    */
    ...
    'ascii' => 'Fältet :attribute får endast innehålla enkla alfanumeriska tecken och symboler.',
    ...
    'distinct' => 'Fältet :attribute innehåller ett duplicerat värde.',
    ...
    'encoding' => 'Fältet :attribute måste kodas i :encoding.',
    'ends_with' => 'Fältet :attribute måste sluta med ett av följande: :values.',
    ...
    'gt' => [
        ...
        'string' => 'Fältet :attribute måste innehålla fler än :value tecken.',
    ],
    'gte' => [
        ...
        'string' => 'Fältet :attribute måste innehålla fler än eller lika med :value tecken.',
    ],
    'hex_color' => 'Fältet :attribute måste vara en giltig hexadecimalt färg.',
    ...
    'lowercase' => 'Fältet :attribute måste vara små bokstäver.',
    'lt' => [
        ...
        'string' => 'Fältet :attribute måste innehålla färre än :value tecken.',
    ],
    'lte' => [
        ...
        'string' => 'Fältet :attribute måste innehålla färre än eller lika med :value tecken.',
    ],
    ...
    'max' => [
        ...
        'string' => 'Fältet :attribute får inte innehålla fler än :max tecken.',
    ],
    ...
    'missing_unless' => 'Fältet :attribute måste saknas om :other inte är :value.',
    ...
    'not_regex' => 'Fältets :attribute-format är ogiltigt.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Det angivna :attribute har förekommit i ett dataläckage. Vänligen välj ett annat :attribute.',
    ],
    'present' => 'Fältet :attribute måste vara närvarande.',
    'present_if' => 'Fältet :attribute måste vara närvarande när :other är :value.',
    'present_unless' => 'Fältet :attribute måste vara närvarande om :other inte är :value.',
    ...
    'prohibited_if_declined' => 'Fältet :attribute är förbjudet när :other nekas.',
    'prohibited_unless' => 'Fältet :attribute är förbjudet om inte :other är i :values.',
    'prohibits' => 'Fältet :attribute förhindrar att :other är närvarande.',
    'regex' => 'Fältets :attribute-format är ogiltigt.',
    ...
    'required_if_declined' => 'Fältet :attribute är obligatoriskt när :other nekas.',
    'required_unless' => 'Fältet :attribute är obligatoriskt om :other inte finns i :values.',
    ...
    'required_without_all' => 'Fältet :attribute är obligatoriskt när inga av :values finns.',
    ...
    'size' => [
        ...
        'string' => 'Fältet :attribute måste innehålla :size tecken.',
    ],
