...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Následující řádky obsahují výchozí chybová hlášení používaná
    | validační třídou. Některá pravidla mají více variant, jako jsou pravidla pro velikost.
    | Můžete je upravit podle potřeby.
    |
    */
    ...
    'doesnt_contain' => 'Pole :attribute nesmí obsahovat následující hodnoty: :values.',
    ...
    'gte' => [
        ...
        'string' => 'Pole :attribute musí mít více nebo rovno :value znaků.',
    ],
    ...
    'missing_with' => 'Pole :attribute musí chybět, pokud :values je přítomen.',
    'missing_with_all' => 'Pole :attribute musí chybět, pokud :values jsou přítomny.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Zadané :attribute se objevilo v úniku dat. Vyberte jiné :attribute.',
    ],
    ...
    'present_with' => 'Pole :attribute musí být přítomno, pokud :values jsou přítomny.',
    'present_with_all' => 'Pole :attribute musí být přítomno, pokud :values jsou přítomny.',
    'prohibited' => 'Pole :attribute je zakázáno.',
    'prohibited_if' => 'Pole :attribute je zakázáno, pokud :other je :value.',
    'prohibited_if_accepted' => 'Pole :attribute je zakázáno, pokud :other je přijato.',
    ...
    'required_with' => 'Pole :attribute je povinné, pokud :values jsou přítomny.',
