...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | I seguenti messaggi contengono gli errori di validazione predefiniti.
    | Alcune regole hanno più versioni, come le regole di dimensione.
    |
    */
    ...
    'between' => [
        ...
        'file' => 'Il campo :attribute deve avere dimensioni tra :min e :max kilobyte.',
    ...
    'lowercase' => 'Il campo :attribute deve essere in lettere minuscole.',
    'lt' => [
