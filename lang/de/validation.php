...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Die folgenden Zeilen enthalten die Standard-Fehlermeldungen für die
    | Validator-Klasse. Einige Regeln haben mehrere Varianten, wie z.B. die
    | Größenregeln. Passen Sie diese Meldungen bei Bedarf an.
    |
    */
