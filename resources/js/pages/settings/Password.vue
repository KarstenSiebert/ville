...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall :title="$t('update_password')"
                    :description="$t('ensure_your_account_is_using_a_long_password')" />
                ...
                <Form v-bind="PasswordController.update.form()" :options="{
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="current_password" name="current_password" type="password" class="mt-1 block w-full"
                            autocomplete="current-password" :placeholder="$t('current_password')" />
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="password" name="password" type="password" class="mt-1 block w-full"
                            autocomplete="new-password" :placeholder="$t('new_password')" />
                    ...
                    <div class="flex items-center gap-4">
                        <Button :disabled="processing" data-test="update-password-button">{{ $t('save_password')
                        }}</Button>
