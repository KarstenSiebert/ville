...
import { reloadRolesAndPermissions, is } from 'laravel-permission-to-vuejs'
...
const mainTrustedUserNavItems: NavItem[] = [
    {
        title: 'trades',
        href: markettrades.index(),
        icon: ChartLine,
...
function updateNavItems() {
    ...
    } else if (is('operator|trusted_user')) {
        navItems.value = mainTrustedUserNavItems
    ...
    <div>
        <div class="border-b border-sidebar-border/80">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <div class="lg:hidden">
                    <Sheet>
                        ...
                        <SheetContent side="left" class="w-[300px] p-6">
                            ...
                            <div v-if="auth?.user" class="flex h-full flex-1 flex-col justify-between space-y-4 py-6">
                                <nav class="-mx-3 space-y-1">
                                    <Link v-for="item in navItems" :key="item.title" :href="item.href"
                ...
                <!-- Desktop Menu -->
                <div v-if="auth?.user" class="hidden h-full lg:flex lg:flex-1">
                ...
                <div v-if="auth?.user" class="ml-auto flex items-center space-x-2">
                    <DropdownMenu>
