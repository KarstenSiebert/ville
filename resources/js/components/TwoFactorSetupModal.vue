...
const modalConfig = computed<{
    ...
    if (props.twoFactorEnabled) {
        return {
            title: 'two_factor_authentication_enabled',
            description:
                'two_factor_authentication_is_now_enabled',
            buttonText: 'close',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            title: 'verify_authentication_code',
            description: 'enter_the_digit_code',
            buttonText: 'continue',
        };
    }
    ...
    return {
        ...
        description: 'to_finish_enabling_two_factor_authentication',
        buttonText: 'continue',
    };
});
                ...
                <template v-if="!showVerificationStep">
                    ...
                    <template v-else>
                        ...
                        <div class="relative flex w-full items-center justify-center">
                            ...
                            <span class="relative bg-card px-2 py-1">{{ $t('or_enter_the_code_manually') }}</span>
                        </div>
